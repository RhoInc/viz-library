...
examples.forEach(function(ex) {
    ...
    if (ex.paths.package) {
        var lines = fs.readFileSync(ex.paths.root + ex.paths.package, 'utf8').toString();
        ...
        console.error(
            "ERROR: Can't create index.html " + ex.paths.root + ' since no package.json was found.'
        );
    }
...
saveData.saveData('./util/web/data/examples', examples);
