...
glob("./data/**/*.csv", function(err, files) {
  ...
  fs.writeFile(
    "./examples/0012-web-codebook-explorer/webCodebookExplorer.js",
    text,
    function(err) {
      if (err) {
      ...
      console.log(
        "The code to produce example 0012-web-codebook-explorer was written!"
      );
    }
  );
});
