...
function buildFilters(meta, measures, parentElement) {
  ...
  wraps.append("div").attr("class", "controlLabel").text(function (d) {
...
function buildPubList(meta, parentElement) {
  ...
  //title
  wraps.append("p").attr("class", "title").text(function (d) {
    return d.title;
  });

  //description
  wraps.append("p").attr("class", "description").text(function (d) {
    return d.text;
  });

  //author
  wraps.append("p").attr("class", "author").text(function (d) {
  ...
  taglist.selectAll("li").data(function (d) {
    return d.links;
